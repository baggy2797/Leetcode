<h2>1426. Counting Elements</h2><h3>Easy</h3><hr><div><p>Given an integer array <code>arr</code>, count how many elements&nbsp;<code>x</code>&nbsp;there are, such that <code>x + 1</code> is also in <code>arr</code>.</p>
